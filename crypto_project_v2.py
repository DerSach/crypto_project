...
def get_trades_and_portfolio_dfs():
...
def print_portfolios(trades_df, portfolio_df):
...
def main():
    ...
    if choice not in ['see','add','remove','profit']:
        ...
        trades_df, portfolio_df = get_trades_and_portfolio_dfs()
        if choice == 'see':
            print_portfolios(trades_df, portfolio_df)
            print()
        if choice == 'add':
